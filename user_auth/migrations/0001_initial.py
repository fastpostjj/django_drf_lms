    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, null=True, upload_to='users_auth/', verbose_name='аватар')),
                ('country', models.CharField(blank=True, max_length=150, null=True, verbose_name='страна')),
                ('id_payment_method', models.CharField(blank=True, max_length=150, null=True, verbose_name='id метода платежа')),
